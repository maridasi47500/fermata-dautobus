...
class PassagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passage" do
    assert_difference("Passage.count") do
      post passages_url, params: { passage: { description: @passage.description, myscore: @passage.myscore, piece_id: @passage.piece_id, title: @passage.title } }
    end
  ...
  test "should update passage" do
    patch passage_url(@passage), params: { passage: { description: @passage.description, myscore: @passage.myscore, piece_id: @passage.piece_id, title: @passage.title } }
